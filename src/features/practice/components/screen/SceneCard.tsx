...
// english.ui.json `situCard` (white / radius20 / padding18 / gap12) に準拠 (practice 版)。
// 通常問題は見出しが「シーン」固定 (復習は別 feature で「復習ポイント」固定)
export function SceneCard({ question }: SceneCardProps) {
  return (
    <section className="flex flex-col gap-3 rounded-[20px] bg-white p-4.5">
      <p className="text-[11px] font-bold text-primary-alt">シーン</p>
